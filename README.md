...
[![Reports](https://img.shields.io/badge/Reports-22%20Lab%20Reports-brightgreen)](reports/README.md)
...
> This repository is the **archival research record and laboratory notebook**. It contains experimental reports, findings, and architecture documentation.  
...
| :--- | :--- |
| 📝 **[Research Progress Reports](reports/README.md)** | 22 chronological laboratory reports documenting 16 weeks of experimental progression and findings. |
| 📑 **[Curated References](REFERENCES.md)** | Academic papers, DOIs, and original-source links. |
| 📊 **[French Project Presentation](reports/french-project-presentation.md)** | Retained speaker presentation source (usable with Obsidian Advanced Slides). |
...
| **Quectel 5G / WireGuard Split** | **78 Mbps** | Caged WireGuard tunnel over 5G modem backhaul to access cell | [Report 22](reports/report-22.md) |
...
- [`french-project-presentation.md`](reports/french-project-presentation.md) (Markdown / Obsidian Advanced Slides)
...
└── reports/                   # Chronological research reports (02 to 22)
    ...
    ├── french-project-presentation.md # Presentation source
