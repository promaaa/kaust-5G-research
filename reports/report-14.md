...
5. LaTeX documentation started in the deployment repository: `overleaf/main.tex` consolidates the deployment history, current topology, and reproducible procedures.
...
![Hardware discovery view](assets/hardware-discovery.png)
...
![PWS message manager](assets/pws-message-manager.png)
...
---
![Experiment helper view](assets/experiment-console.png)
...
![Preflight gate results](assets/preflight-validation.png)
...
![Throughput by configuration](assets/early-throughput-comparison.png)
...
![Deployment interface](assets/deployment-interface.png)
